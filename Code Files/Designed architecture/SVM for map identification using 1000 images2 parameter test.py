...
for train_size in train_size_list:
    ...
    for inx in range(1):
        ...
        x_test_array = X_batches[800:num_total]
        y_train_array = y_batches[0:train_size]
        y_test_array = y_batches[800:num_total]
        ...
        x_test = [{j: x_test_array[i][j]
                for j in range(input_size)} for i in range(num_total-800)]
    ...
    filename = 'SVMforIdentification2_parameters'+'.txt'
