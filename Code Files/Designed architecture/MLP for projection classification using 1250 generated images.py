...
path_root = 'C:\\Users\\jiali\\OneDrive - The Ohio State University\\Images for training\\maps for classification of projections\\generated maps\\'
...
for ls in layerSettings:
    ...
    for inx in range(3):
        ...
        with open(path_root +'test_classification_projection1250_mlp.pickle', 'rb') as file:
    ...
    filename='MLPforProjection_10_6_generated'+'.txt'
